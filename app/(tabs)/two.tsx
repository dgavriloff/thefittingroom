...
export default function TabTwoScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {hasSelection && (
        <Animated.View entering={FadeIn.duration(200)} exiting={FadeOut.duration(200)} style={styles.floatingButtonContainer}>
          <TouchableOpacity style={styles.floatingButton} onPress={() => Alert.alert('Try it on', 'Feature coming soon!')}>
            <Text style={styles.floatingButtonText}>Try it on</Text>
          </TouchableOpacity>
        </Animated.View>
      )}
    </View>
